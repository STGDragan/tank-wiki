...
export const EquipmentCard = ({ equipment }: { equipment: Equipment }) => {
  return (
    <Card className="h-full">
      ...
      <CardContent>
        <img src={`https://placehold.co/400x300/10B981/FFFFFF?text=${equipment.type.replace(/\s/g, '+')}`} alt={equipment.type} className="rounded-md mb-4 aspect-video object-cover" />
