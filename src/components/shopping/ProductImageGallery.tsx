...
export const ProductImageGallery = ({ images, productName, primaryImage }: ProductImageGalleryProps) => {
  ...
  if (allImages.length <= 1) {
    return (
      <div className="w-full min-h-64 max-h-[32rem] overflow-hidden rounded-lg border bg-muted flex items-center justify-center">
        <img
          src={primaryImage}
          alt={productName}
  ...
  return (
    <div className="space-y-4">
      {/* Main image display */}
      <div className="relative w-full min-h-64 max-h-[32rem] overflow-hidden rounded-lg border bg-muted flex items-center justify-center">
        <img
