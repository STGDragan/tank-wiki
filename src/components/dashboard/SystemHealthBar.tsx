...
export const SystemHealthBar = () => {
  ...
  const getHealthColor = (score: number) => {
    ...
    if (score >= 60) return "from-cyan-400 to-cyan-600";
    return "from-red-400 to-red-600";
  };

  const getGlowColor = (score: number) => {
    if (score >= 80) return "shadow-green-400/60";
    if (score >= 60) return "shadow-cyan-400/60";
  ...
  return (
    <div>
      <div className="mb-4">
        <h3 className="text-lg font-display font-bold text-cyan-400 flex items-center gap-2">
      ...
      <div className="flex justify-between items-center mt-4 text-sm">
        ...
        <span className="text-cyan-400 font-mono">CAUTION</span>
