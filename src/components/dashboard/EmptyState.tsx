...
export function EmptyState({ aquariumCount }: EmptyStateProps) {
  return (
    <Card className="border-2 border-dashed border-blue-200/60 bg-gradient-to-br from-blue-50/80 to-cyan-50/80 backdrop-blur-sm dark:border-slate-600/60 dark:from-slate-800/80 dark:to-slate-700/80">
      <CardContent className="flex flex-col items-center justify-center py-16 px-6 text-center">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/50 dark:to-cyan-900/50 flex items-center justify-center mb-6 shadow-soft">
          <Fish className="h-10 w-10 text-blue-600 dark:text-blue-400" />
        </div>
        <h3 className="text-2xl font-semibold mb-3 text-slate-800 dark:text-slate-200">No aquariums yet!</h3>
