    ...
    <div className="flex flex-col min-h-screen bg-background overflow-x-hidden">
      ...
      <main className="flex-1">
        <section className="relative flex flex-col items-center justify-center text-center overflow-hidden pt-20 pb-8 min-h-screen">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10 mb-8 max-w-full">
          ...
          <div className="w-full max-w-6xl mx-auto px-4 md:px-6 relative z-10 animate-slide-in overflow-hidden" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
