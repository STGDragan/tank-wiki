...
import { detailedMarineFishNames } from './detailedFishData';

export const saltwaterFish = [
  // Original species from your existing data
  ...
  // New detailed marine fish species
  ...detailedMarineFishNames
];
